/*
Auteur: Christopher-William Archambault-Bouffard,
        Antoine Lamoureux,
        Jules Edmond
Date:   21/09/2020
*/
...
public class Tests {
    ...
    public static void enleverDonneesDeTest() {
        app.enleverVehicule(0);
        app.enleverVehicule(1);
        app.enleverVehicule(2);
        app.enleverVehicule(3);
    }
